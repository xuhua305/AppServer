...
namespace NG3.AppServer
{
    ...
    internal class NGWebServerException : Exception
    {
        public NGWebServerException(string message, ErrorField field, Exception innerException)
            : base(message, innerException)
        {
            Field = field;
        }

        public NGWebServerException(string message, ErrorField field)
